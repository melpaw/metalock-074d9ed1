...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "MetaLock is a security-first crypto platform: identity-locked transfers, HSM-backed key custody and end-to-end encryption." },
      { name: "author", content: "MetaLock" },
      { property: "og:title", content: "MetaLock — Identity-locked crypto vault" },
      { property: "og:description", content: "MetaLock is a security-first crypto platform: identity-locked transfers, HSM-backed key custody and end-to-end encryption." },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "MetaLock" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "MetaLock — Identity-locked crypto vault" },
      { name: "twitter:description", content: "MetaLock is a security-first crypto platform: identity-locked transfers, HSM-backed key custody and end-to-end encryption." },
    ],
    links: [
